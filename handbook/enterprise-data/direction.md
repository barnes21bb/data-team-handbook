...
As an important step towards achieving our [mission](/handbook/enterprise-data/data-team.md) and meeting our [responsibilities](/handbook/enterprise-data/data-team.md) we are creating an Enterprise Data Platform (EDP), a single unified data and analytics stack, along with a broad suite of Data Programs such as Self-Serve Data and Data Quality. The EDP will power Simmons Foods KPIs, cross-functional reporting and analysis, and in general, allow all team members to make better decisions with trusted data. Over time, the EDP will further accelerate Simmons Foods analytics capabilities with a well-structured data warehouse, enriched and aggregated data products for business intelligence, and predictive models embedded into business systems and shopfloor processes.

### 1) Customer Centricity

Definition:

1. Visibility and deep understanding of how our business operates and how data is used across functions
1. Focus on the Customer Journey Lifecycle & Related Analytics
1. Build a Better Simmons Foods for our Customers
...
### 3) Simmons Foods Culture of Data First
